                ...
                DeleteAction::make()
                    ->before(function (DeleteAction $action, $record) {
                        if ($record->projects()->exists()) {
                            Notification::make()->warning()->title('Không thể xóa!')->body('Danh mục đang chứa dự án.')->send();
                            $action->cancel();
                        }
                        ...
                        ->action(function (Collection $records, DeleteBulkAction $action) {
                            ...
                            if ($prevented > 0) {
                                Notification::make()
                                    ...
                                    ->body("Không thể xóa {$prevented} danh mục vì đang chứa dự án hoặc thư mục con.")
                                    ->send();
                            } else {

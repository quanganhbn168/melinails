...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('general.company_name', 'Công ty Cổ phần Bán lẻ CNETPos');
        $this->migrator->add('general.description', 'CNETPos - Giải pháp phần mềm quản lý bán hàng chuyên nghiệp dành cho doanh nghiệp trong kỷ nguyên số.');

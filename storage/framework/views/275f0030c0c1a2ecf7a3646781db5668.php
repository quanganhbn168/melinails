...
<?php $__env->startSection('content_header','Danh sách slide'); ?>
		...
		<table class="table table-hover text-nowrap">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<img src="<?php echo e(asset($slide->image)); ?>" alt="Slide" style="height: 80px;">
					</td>
					<td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.boolean-toggle','data' => ['model' => 'slide','record' => $slide,'field' => 'status']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['model' => 'slide','record' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($slide),'field' => 'status']); ?>
...
<?php endif; ?>
					...
					<td><?php echo e($slide->created_at->format('d/m/Y')); ?></td>
					<td><?php echo e($slide->updated_at->format('d/m/Y')); ?></td>
					<td>
						<a href="<?php echo e(route('admin.slides.edit', $slide)); ?>" class="btn btn-warning">
							<i class="far fa-edit"></i>
						</a>
						<form action="<?php echo e(route('admin.slides.destroy', $slide)); ?>" method="POST" style="display:inline-block;" class="form-delete">
							<?php echo csrf_field(); ?>

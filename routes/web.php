...
use App\Http\Controllers\Frontend\MelinailsController;

Route::get("/", [MelinailsController::class, "home"])->name("home");
Route::get('/o-nas', [MelinailsController::class, 'about'])->name('meli.about');
Route::get('/sluzby', [MelinailsController::class, 'services'])->name('meli.services');
Route::get('/sluzby/{slug}', [MelinailsController::class, 'serviceCategory'])->name('meli.service.category');
Route::get('/sluzba/{slug}', [MelinailsController::class, 'serviceDetail'])->name('meli.service.detail');
Route::get('/cenik', [MelinailsController::class, 'prices'])->name('meli.prices');
Route::get('/galerie', [MelinailsController::class, 'gallery'])->name('meli.gallery');
Route::get('/pobocky', [MelinailsController::class, 'branches'])->name('meli.branches');
Route::get('/rezervace', [MelinailsController::class, 'booking'])->name('meli.booking');
Route::post('/rezervace', [MelinailsController::class, 'bookingStore'])->name('meli.booking.store');
Route::get('/rezervace/dekujeme/{code}', [MelinailsController::class, 'bookingThankYou'])->name('meli.booking.thank-you');
Route::get('/kontakt', [MelinailsController::class, 'contact'])->name('meli.contact');
